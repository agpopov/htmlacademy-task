...
class WidgetRequestValidationTest extends TestCase
{
    public function test_width_validation_errors()
    {
        ...
        $response = $this->get(route('widget', ['userId' => $this->faker->uuid, 'width' => $width]));
    ...
    public function test_height_validation_errors()
    {
        ...
        $response = $this->get(route('widget', ['userId' => $this->faker->uuid, 'height' => $height]));
        $response->assertStatus(422);
    ...
    public function test_background_color_validation_errors()
    {
        ...
        $response = $this->get(route('widget', ['userId' => $this->faker->uuid, 'background_color' => $color]));
        $response->assertStatus(422);
    ...
    {
        $color = $this->faker->boolean;
        $response = $this->get(route('widget', ['userId' => $this->faker->uuid, 'text_color' => $color]));
        $response->assertStatus(422);
